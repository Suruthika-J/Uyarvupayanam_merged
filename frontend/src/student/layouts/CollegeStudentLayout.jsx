...
import {
  ...
  FiClock, FiCode, FiUsers, FiActivity
} from 'react-icons/fi'

function CollegeStudentSidebar({ student, logout, mobileOpen, setMobileOpen }) {
  ...
  const navItems = [
    ...
    { id: 'practice',      icon: practiceConfig.isComputing ? FiCode : FiActivity, label: practiceConfig.navLabel, to: '/college/practice' },
