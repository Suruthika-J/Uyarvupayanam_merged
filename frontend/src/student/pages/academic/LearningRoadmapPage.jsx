...
export default function LearningRoadmapPage() {
  ...
  const fetchRoadmap = async () => {
    ...
    try {
      ...
      setError('We couldn’t reach the roadmap engine. Please try again in a moment.')
    } finally {
      setLoading(false)
    }
  }
  ...
  if (loading) {
    return (
      <div style={{ maxWidth: 900, margin: '0 auto', paddingTop: 20 }}>
        <AIGenerating
          label="Generating your learning roadmap"
          sub="Mapping your coursework to target-career milestones and verifying readiness checkpoints..."
        />
      </div>
    )
  }
