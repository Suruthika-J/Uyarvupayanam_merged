...
const scienceProgressSchema = new mongoose.Schema(
  {
...
scienceProgressSchema.index({ studentId: 1, questionId: 1 }, { unique: true });
module.exports = mongoose.model("ScienceProgress", scienceProgressSchema);